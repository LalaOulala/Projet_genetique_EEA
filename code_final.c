...
int main(void)
{
    ...
    for(i = 0; i < 100; i++)
    {
        ...
        ValeursY0[i] = genererValeurAleatoire(2100, 2300);
        ValeursB[i] = genererValeurAleatoire(100000, 150000);
        ValeursDeltaLambda[i] = genererValeurAleatoire(100000, 300000);
        ValeursLambdaZero[i] = genererValeurAleatoire(65600000, 65640000);
